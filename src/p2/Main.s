...
! SEND STATEMENT...
	...
	mov	"\0\0SE",r10
!   _temp_313 = &_Global_conSem
	set	_Global_conSem,r1
	store	r1,[r14+-216]
...
! SEND STATEMENT...
	...
	mov	"\0\0SE",r10
!   _temp_314 = &_Global_proSem
	set	_Global_proSem,r1
	store	r1,[r14+-212]
...
!   Next value...
	...
	store	r1,[r14+-16]
_Label_604:
!   Data Move: *_temp_602 = 3  (sizeInBytes=4)
	mov	3,r1
	load	[r14+-20],r2
	store	r1,[r2]
!   _temp_602 = _temp_602 + 4
...
!   make sure array has size 5
	...
	bvs	_runtimeErrorOverflow
	bne	_runtimeErrorWrongArraySize
!   Data Move: *_temp_600 = *_temp_605  (sizeInBytes=24)
	load	[r14+-12],r5
	load	[r14+-48],r4
	load	[r5],r1
	store	r1,[r4]
...
!   _temp_626 = &status
	...
	add	r1,4,r1
	store	r1,[r14+-28]
!   Move address of _temp_626 [p ] into _temp_627
!     make sure index expr is >= 0
	load	[r14+12],r2
	cmp	r2,0
	bl	_runtimeErrorBadArrayIndex
...
!     compute address of array element
	...
	add	r2,r1,r2
	store	r2,[r14+-24]
!   Data Move: _temp_625 = *_temp_627  (sizeInBytes=4)
	load	[r14+-24],r1
	load	[r1],r1
	store	r1,[r14+-32]
!   if _temp_625 == 2 then goto _Label_624		(int)
	load	[r14+-32],r1
	mov	2,r2
	cmp	r1,r2
	be	_Label_624
...
!   _temp_646 = &status
	...
	add	r1,4,r1
	store	r1,[r14+-56]
!   Move address of _temp_646 [p ] into _temp_647
!     make sure index expr is >= 0
	load	[r14+12],r2
	cmp	r2,0
	bl	_runtimeErrorBadArrayIndex
...
!     compute address of array element
	...
	add	r2,r1,r2
	store	r2,[r14+-52]
!   Data Move: *_temp_647 = 3  (sizeInBytes=4)
	mov	3,r1
	load	[r14+-52],r2
	store	r1,[r2]
! SEND STATEMENT...
...
!   _temp_679 = &status
	...
	add	r1,4,r1
	store	r1,[r14+-76]
!   Move address of _temp_679 [p ] into _temp_680
!     make sure index expr is >= 0
	load	[r14+12],r2
	cmp	r2,0
	bl	_runtimeErrorBadArrayIndex
...
!   Data Move: _temp_678 = *_temp_680  (sizeInBytes=4)
	...
	load	[r1],r1
	store	r1,[r14+-80]
!   if _temp_678 != 1 then goto _Label_675		(int)
	load	[r14+-80],r1
	mov	1,r2
	cmp	r1,r2
	bne	_Label_675
...
!   _temp_683 = _temp_684 rem 5		(int)
	...
	bvs	_runtimeErrorOverflow
	store	r1,[r14+-60]
!   Move address of _temp_682 [_temp_683 ] into _temp_685
!     make sure index expr is >= 0
	load	[r14+-60],r2
	cmp	r2,0
	bl	_runtimeErrorBadArrayIndex
...
!   Data Move: _temp_681 = *_temp_685  (sizeInBytes=4)
	...
	load	[r1],r1
	store	r1,[r14+-68]
!   if _temp_681 == 2 then goto _Label_675		(int)
	load	[r14+-68],r1
	mov	2,r2
	cmp	r1,r2
	be	_Label_675
...
!   _temp_688 = _temp_689 rem 5		(int)
	...
	bvs	_runtimeErrorOverflow
	store	r1,[r14+-40]
!   Move address of _temp_687 [_temp_688 ] into _temp_690
!     make sure index expr is >= 0
	load	[r14+-40],r2
	cmp	r2,0
	bl	_runtimeErrorBadArrayIndex
...
!     compute address of array element
	...
	add	r2,r1,r2
	store	r2,[r14+-32]
!   Data Move: _temp_686 = *_temp_690  (sizeInBytes=4)
	load	[r14+-32],r1
	load	[r1],r1
	store	r1,[r14+-48]
!   if _temp_686 == 2 then goto _Label_675		(int)
	load	[r14+-48],r1
	mov	2,r2
	cmp	r1,r2
	be	_Label_675
...
!     compute address of array element
	...
	add	r2,r1,r2
	store	r2,[r14+-24]
!   Data Move: *_temp_692 = 2  (sizeInBytes=4)
	mov	2,r1
	load	[r14+-24],r2
	store	r1,[r2]
! SEND STATEMENT...
...
!   _temp_722 = 4		(4 bytes)
	...
	store	r1,[r14+-36]
!   Initialize FOR-LOOP index variable
!   Data Move: p = _temp_721  (sizeInBytes=4)
	load	[r14+-40],r1
	store	r1,[r14+-44]
_Label_717:
!   Perform the FOR-LOOP termination test
!   if p > _temp_722 then goto _Label_720		
	load	[r14+-44],r1
	load	[r14+-36],r2
	cmp	r1,r2
	bvs	_runtimeErrorOverflow
...
!   _temp_729 = &status
	...
	add	r1,4,r1
	store	r1,[r14+-28]
!   Move address of _temp_729 [p ] into _temp_730
!     make sure index expr is >= 0
	load	[r14+-44],r2
	cmp	r2,0
	bl	_runtimeErrorBadArrayIndex
...
!     compute address of array element
	...
	add	r2,r1,r2
	store	r2,[r14+-24]
!   Data Move: _temp_728 = *_temp_730  (sizeInBytes=4)
	load	[r14+-24],r1
	load	[r1],r1
	store	r1,[r14+-32]
