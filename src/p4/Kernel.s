...
! SEND STATEMENT...
	...
	mov	"\0\0SE",r10
!   _temp_993 = &processTable
	load	[r14+8],r1
	add	r1,4,r1
	store	r1,[r14+-28]
!   Move address of _temp_993 [i ] into _temp_994
!     make sure index expr is >= 0
	load	[r14+-52],r2
	cmp	r2,0
	bl	_runtimeErrorBadArrayIndex
...
! SEND STATEMENT...
	...
	mov	"\0\0SE",r10
!   _temp_996 = _function_125_PrintObjectAddr
	set	_function_125_PrintObjectAddr,r1
	store	r1,[r14+-16]
!   _temp_997 = &freeList
	load	[r14+8],r1
...
!   _temp_1020 = &processTable
	...
	add	r1,4,r1
	store	r1,[r14+-28]
!   Move address of _temp_1020 [i ] into _temp_1021
!     make sure index expr is >= 0
	load	[r14+-48],r2
	cmp	r2,0
	bl	_runtimeErrorBadArrayIndex
...
! SEND STATEMENT...
	...
	mov	"\0\0SE",r10
!   _temp_1023 = _function_125_PrintObjectAddr
	set	_function_125_PrintObjectAddr,r1
	store	r1,[r14+-16]
!   _temp_1024 = &freeList
	load	[r14+8],r1
...
! FOR STATEMENT...
	...
	mov	"\0\0FO",r10
!   Calculate and save the FOR-LOOP starting value
!   _temp_1056 = 1048576		(4 bytes)
	set	1048576,r1
	store	r1,[r14+-24]
!   Calculate and save the FOR-LOOP ending value
!   _temp_1057 = 1048876		(4 bytes)
	set	1048876,r1
	store	r1,[r14+-20]
!   Initialize FOR-LOOP index variable
!   Data Move: i = _temp_1056  (sizeInBytes=4)
	load	[r14+-24],r1
	store	r1,[r14+-56]
_Label_1052:
!   Perform the FOR-LOOP termination test
!   if i > _temp_1057 then goto _Label_1055		
	load	[r14+-56],r1
	load	[r14+-20],r2
	cmp	r1,r2
	bvs	_runtimeErrorOverflow
...
!   if intIsZero (i) then goto _runtimeErrorNullPointer
	...
	cmp	r1,r0
	be	_runtimeErrorNullPointer
!   Data Move: _temp_1060 = *i  (sizeInBytes=4)
	load	[r14+-56],r1
	load	[r1],r1
	store	r1,[r14+-16]
!   if intIsZero (_temp_1060) then goto _Label_1059
	load	[r14+-16],r1
	cmp	r1,r0
	be	_Label_1059
!	jmp	_Label_1058
...
! WHILE STATEMENT...
	...
	mov	"\0\0WH",r10
_Label_1091:
!   if numberFreeFrames >= 1 then goto _Label_1093		(int)
	load	[r14+8],r1
	load	[r1+16],r1
	mov	1,r2
	cmp	r1,r2
...
! SEND STATEMENT...
	...
	mov	"\0\0SE",r10
!   _temp_1094 = &frameManagerLock
	load	[r14+8],r1
	add	r1,20,r1
	store	r1,[r14+-28]
!   _temp_1095 = &newFramesAvailable
	load	[r14+8],r1
	add	r1,40,r1
	store	r1,[r14+-24]
...
! ASSIGNMENT STATEMENT...
	...
	mov	"\0\0AS",r10
!   _temp_1098 = f * 8192		(int)
	load	[r14+-36],r1
	mov	8192,r2
	mul	r1,r2,r1
	bvs	_runtimeErrorOverflow
	store	r1,[r14+-12]
!   frameAddr = 1048576 + _temp_1098		(int)
	set	1048576,r1
	load	[r14+-12],r2
	add	r1,r2,r1
	bvs	_runtimeErrorOverflow
...
! ASSIGNMENT STATEMENT...
	...
	mov	"\0\0AS",r10
!   _temp_1118 = &pageTable
	load	[r14+8],r1
	add	r1,8,r1
	store	r1,[r14+-108]
!   NEW ARRAY Constructor...
!   _temp_1120 = &_temp_1119
	add	r14,-104,r1
	store	r1,[r14+-20]
!   _temp_1120 = _temp_1120 + 4
	load	[r14+-20],r1
	add	r1,4,r1
	store	r1,[r14+-20]
!   Next value...
	...
	store	r1,[r14+-16]
_Label_1122:
!   Data Move: *_temp_1120 = 3  (sizeInBytes=4)
	mov	3,r1
	load	[r14+-20],r2
	store	r1,[r2]
!   _temp_1120 = _temp_1120 + 4
	...
	add	r1,4,r1
	store	r1,[r14+-20]
!   _temp_1121 = _temp_1121 + -1
	load	[r14+-16],r1
	add	r1,-1,r1
	store	r1,[r14+-16]
!   if intNotZero (_temp_1121) then goto _Label_1122
	load	[r14+-16],r1
	cmp	r1,r0
	bne	_Label_1122
!   Initialize the array size...
...
!   make sure array has size 20
	...
	bvs	_runtimeErrorOverflow
	bne	_runtimeErrorWrongArraySize
!   Data Move: *_temp_1118 = *_temp_1123  (sizeInBytes=84)
	load	[r14+-12],r5
	load	[r14+-108],r4
	mov	21,r3
_Label_1635:
...
!   _temp_1137 = 0		(4 bytes)
	...
	store	r1,[r14+-156]
!   Calculate and save the FOR-LOOP ending value
!   _temp_1138 = numberOfPages - 1		(int)
	load	[r14+8],r1
	load	[r1+4],r1
	mov	1,r2
	sub	r1,r2,r1
...
!   Send message ExtractUndefinedBits
	...
	add	r2,16,r2
	call	r2
!   Retrieve Result: targetName=_temp_1155  sizeInBytes=4
	load	[r15],r1
	store	r1,[r14+-92]
!   if intIsZero (_temp_1155) then goto _Label_1154
	load	[r14+-92],r1
	cmp	r1,r0
	be	_Label_1154
!	jmp	_Label_1153
...
! CALL STATEMENT...
	...
	load	[r14+8],r1
	store	r1,[r14+-80]
!   if intIsZero (_temp_1158) then goto _runtimeErrorNullPointer
	load	[r14+-80],r1
	cmp	r1,r0
	be	_runtimeErrorNullPointer
!   Prepare Argument: offset=12  value=i  sizeInBytes=4
...
!   Send message ExtractUndefinedBits
	...
	add	r2,16,r2
	call	r2
!   Retrieve Result: targetName=_temp_1157  sizeInBytes=4
	load	[r15],r1
	store	r1,[r14+-84]
...
!   Send message IsDirty
	...
	add	r2,24,r2
	call	r2
!   if result==true then goto _Label_1162 else goto _Label_1163
	loadb	[r15],r1
	cmp	r1,0
	be	_Label_1163
	jmp	_Label_1162
...
!   Send message IsReferenced
	...
	add	r2,28,r2
	call	r2
!   if result==true then goto _Label_1169 else goto _Label_1170
	loadb	[r15],r1
	cmp	r1,0
	be	_Label_1170
	jmp	_Label_1169
...
!   Send message IsWritable
	...
	add	r2,32,r2
	call	r2
!   if result==true then goto _Label_1176 else goto _Label_1177
	loadb	[r15],r1
	cmp	r1,0
	be	_Label_1177
	jmp	_Label_1176
...
! RETURN STATEMENT...
	...
	mov	"\0\0RE",r10
!   _temp_1233 = &pageTable
	load	[r14+8],r1
	add	r1,8,r1
	store	r1,[r14+-16]
!   Move address of _temp_1233 [entry ] into _temp_1234
!     make sure index expr is >= 0
	load	[r14+12],r2
	cmp	r2,0
	bl	_runtimeErrorBadArrayIndex
...
!   Data Move: _temp_1232 = *_temp_1234  (sizeInBytes=4)
	...
	load	[r1],r1
	store	r1,[r14+-20]
!   _temp_1231 = _temp_1232 AND -8192		(int)
	load	[r14+-20],r1
	mov	-8192,r2
	and	r1,r2,r1
	store	r1,[r14+-24]
!   ReturnResult: _temp_1231  (sizeInBytes=4)
	load	[r14+-24],r1
	store	r1,[r14+8]
	add	r15,20,r15
	pop	r13
...
!   Data Move: _temp_1243 = *_temp_1245  (sizeInBytes=4)
	...
	load	[r1],r1
	store	r1,[r14+-20]
!   _temp_1242 = _temp_1243 AND 8176		(int)
	load	[r14+-20],r1
	mov	8176,r2
	and	r1,r2,r1
	store	r1,[r14+-24]
...
!   _temp_1258 = &pageTable
	...
	add	r1,8,r1
	store	r1,[r14+-16]
!   Move address of _temp_1258 [entry ] into _temp_1259
!     make sure index expr is >= 0
	load	[r14+12],r2
	cmp	r2,0
	bl	_runtimeErrorBadArrayIndex
...
!   Data Move: _temp_1257 = *_temp_1259  (sizeInBytes=4)
	...
	load	[r1],r1
	store	r1,[r14+-20]
!   _temp_1256 = _temp_1257 AND 8191		(int)
	load	[r14+-20],r1
	mov	8191,r2
	and	r1,r2,r1
	store	r1,[r14+-24]
!   _temp_1255 = _temp_1256 OR frameAddr		(int)
	load	[r14+-24],r1
	load	[r14+16],r2
	or	r1,r2,r1
	store	r1,[r14+-28]
...
!   _temp_1274 = &pageTable
	...
	add	r1,8,r1
	store	r1,[r14+-20]
!   Move address of _temp_1274 [entry ] into _temp_1275
!     make sure index expr is >= 0
	load	[r14+12],r2
	cmp	r2,0
	bl	_runtimeErrorBadArrayIndex
...
!   Data Move: _temp_1273 = *_temp_1275  (sizeInBytes=4)
	...
	load	[r1],r1
	store	r1,[r14+-24]
!   _temp_1272 = _temp_1273 AND 8		(int)
	load	[r14+-24],r1
	mov	8,r2
	and	r1,r2,r1
	store	r1,[r14+-28]
!   if intIsZero (_temp_1272) then goto _Label_1276
	load	[r14+-28],r1
	cmp	r1,r0
	be	_Label_1276
!   _temp_1271 = 1		(1 byte)
...
!   _temp_1271 = 0		(1 byte)
	...
	storeb	r1,[r14+-9]
_Label_1277:
!   ReturnResult: _temp_1271  (sizeInBytes=1)
	loadb	[r14+-9],r1
	storeb	r1,[r14+8]
	add	r15,24,r15
	pop	r13
...
!   _temp_1289 = &pageTable
	...
	add	r1,8,r1
	store	r1,[r14+-20]
!   Move address of _temp_1289 [entry ] into _temp_1290
!     make sure index expr is >= 0
	load	[r14+12],r2
	cmp	r2,0
	bl	_runtimeErrorBadArrayIndex
...
!   Data Move: _temp_1288 = *_temp_1290  (sizeInBytes=4)
	...
	load	[r1],r1
	store	r1,[r14+-24]
!   _temp_1287 = _temp_1288 AND 4		(int)
	load	[r14+-24],r1
	mov	4,r2
	and	r1,r2,r1
	store	r1,[r14+-28]
!   if intIsZero (_temp_1287) then goto _Label_1291
	load	[r14+-28],r1
	cmp	r1,r0
	be	_Label_1291
!   _temp_1286 = 1		(1 byte)
...
!   _temp_1286 = 0		(1 byte)
	...
	storeb	r1,[r14+-9]
_Label_1292:
!   ReturnResult: _temp_1286  (sizeInBytes=1)
	loadb	[r14+-9],r1
	storeb	r1,[r14+8]
	add	r15,24,r15
	pop	r13
...
!     compute address of array element
	...
	add	r2,r1,r2
	store	r2,[r14+-16]
!   Data Move: _temp_1303 = *_temp_1305  (sizeInBytes=4)
	load	[r14+-16],r1
	load	[r1],r1
	store	r1,[r14+-24]
!   _temp_1302 = _temp_1303 AND 2		(int)
	load	[r14+-24],r1
	mov	2,r2
	and	r1,r2,r1
	store	r1,[r14+-28]
!   if intIsZero (_temp_1302) then goto _Label_1306
	load	[r14+-28],r1
	cmp	r1,r0
	be	_Label_1306
!   _temp_1301 = 1		(1 byte)
...
!   _temp_1301 = 0		(1 byte)
	...
	storeb	r1,[r14+-9]
_Label_1307:
!   ReturnResult: _temp_1301  (sizeInBytes=1)
	loadb	[r14+-9],r1
	storeb	r1,[r14+8]
	add	r15,24,r15
	pop	r13
...
!   Data Move: _temp_1318 = *_temp_1320  (sizeInBytes=4)
	...
	load	[r1],r1
	store	r1,[r14+-24]
!   _temp_1317 = _temp_1318 AND 1		(int)
	load	[r14+-24],r1
	mov	1,r2
	and	r1,r2,r1
	store	r1,[r14+-28]
!   if intIsZero (_temp_1317) then goto _Label_1321
	load	[r14+-28],r1
	cmp	r1,r0
	be	_Label_1321
!   _temp_1316 = 1		(1 byte)
...
!   _temp_1316 = 0		(1 byte)
	...
	storeb	r1,[r14+-9]
_Label_1322:
!   ReturnResult: _temp_1316  (sizeInBytes=1)
	loadb	[r14+-9],r1
	storeb	r1,[r14+8]
	add	r15,24,r15
	pop	r13
...
!     compute address of array element
	...
	add	r2,r1,r2
	store	r2,[r14+-28]
!   _temp_1335 = &pageTable
	load	[r14+8],r1
	add	r1,8,r1
	store	r1,[r14+-16]
!   Move address of _temp_1335 [entry ] into _temp_1336
!     make sure index expr is >= 0
	load	[r14+12],r2
	cmp	r2,0
	bl	_runtimeErrorBadArrayIndex
...
!   Data Move: _temp_1334 = *_temp_1336  (sizeInBytes=4)
	...
	load	[r1],r1
	store	r1,[r14+-20]
!   _temp_1333 = _temp_1334 OR 8		(int)
	load	[r14+-20],r1
	mov	8,r2
	or	r1,r2,r1
	store	r1,[r14+-24]
...
!   Data Move: _temp_1349 = *_temp_1351  (sizeInBytes=4)
	...
	load	[r1],r1
	store	r1,[r14+-20]
!   _temp_1348 = _temp_1349 OR 4		(int)
	load	[r14+-20],r1
	mov	4,r2
	or	r1,r2,r1
	store	r1,[r14+-24]
...
!   Data Move: _temp_1364 = *_temp_1366  (sizeInBytes=4)
	...
	load	[r1],r1
	store	r1,[r14+-20]
!   _temp_1363 = _temp_1364 OR 2		(int)
	load	[r14+-20],r1
	mov	2,r2
	or	r1,r2,r1
	store	r1,[r14+-24]
...
!   Data Move: _temp_1379 = *_temp_1381  (sizeInBytes=4)
	...
	load	[r1],r1
	store	r1,[r14+-20]
!   _temp_1378 = _temp_1379 OR 1		(int)
	load	[r14+-20],r1
	mov	1,r2
	or	r1,r2,r1
	store	r1,[r14+-24]
...
!   Data Move: _temp_1394 = *_temp_1396  (sizeInBytes=4)
	...
	load	[r1],r1
	store	r1,[r14+-20]
!   _temp_1393 = _temp_1394 AND -9		(int)
	load	[r14+-20],r1
	mov	-9,r2
	and	r1,r2,r1
	store	r1,[r14+-24]
...
!     compute address of array element
	...
	add	r2,r1,r2
	store	r2,[r14+-28]
!   _temp_1410 = &pageTable
	load	[r14+8],r1
	add	r1,8,r1
	store	r1,[r14+-16]
!   Move address of _temp_1410 [entry ] into _temp_1411
!     make sure index expr is >= 0
	load	[r14+12],r2
	cmp	r2,0
	bl	_runtimeErrorBadArrayIndex
...
!   Data Move: _temp_1409 = *_temp_1411  (sizeInBytes=4)
	...
	load	[r1],r1
	store	r1,[r14+-20]
!   _temp_1408 = _temp_1409 AND -5		(int)
	load	[r14+-20],r1
	mov	-5,r2
	and	r1,r2,r1
	store	r1,[r14+-24]
...
!     compute address of array element
	...
	add	r2,r1,r2
	store	r2,[r14+-28]
!   _temp_1425 = &pageTable
	load	[r14+8],r1
	add	r1,8,r1
	store	r1,[r14+-16]
!   Move address of _temp_1425 [entry ] into _temp_1426
!     make sure index expr is >= 0
	load	[r14+12],r2
	cmp	r2,0
	bl	_runtimeErrorBadArrayIndex
...
!     compute address of array element
	...
	add	r2,r1,r2
	store	r2,[r14+-12]
!   Data Move: _temp_1424 = *_temp_1426  (sizeInBytes=4)
	load	[r14+-12],r1
	load	[r1],r1
	store	r1,[r14+-20]
!   _temp_1423 = _temp_1424 AND -3		(int)
	load	[r14+-20],r1
	mov	-3,r2
	and	r1,r2,r1
	store	r1,[r14+-24]
!   Data Move: *_temp_1422 = _temp_1423  (sizeInBytes=4)
	load	[r14+-24],r1
	load	[r14+-28],r2
	store	r1,[r2]
! RETURN STATEMENT...
...
!     compute address of array element
	...
	add	r2,r1,r2
	store	r2,[r14+-28]
!   _temp_1440 = &pageTable
	load	[r14+8],r1
	add	r1,8,r1
	store	r1,[r14+-16]
!   Move address of _temp_1440 [entry ] into _temp_1441
!     make sure index expr is >= 0
	load	[r14+12],r2
	cmp	r2,0
	bl	_runtimeErrorBadArrayIndex
...
!     compute address of array element
	...
	add	r2,r1,r2
	store	r2,[r14+-12]
!   Data Move: _temp_1439 = *_temp_1441  (sizeInBytes=4)
	load	[r14+-12],r1
	load	[r1],r1
	store	r1,[r14+-20]
!   _temp_1438 = _temp_1439 AND -2		(int)
	load	[r14+-20],r1
	mov	-2,r2
	and	r1,r2,r1
	store	r1,[r14+-24]
...
!   _temp_1452 = &pageTable
	...
	add	r1,8,r1
	store	r1,[r14+-20]
!   Move address of _temp_1452 [0 ] into _temp_1453
!     make sure index expr is >= 0
	mov	0,r2
	cmp	r2,0
	bl	_runtimeErrorBadArrayIndex
...
!     compute address of array element
	...
	add	r2,r1,r2
	store	r2,[r14+-16]
!   _temp_1451 = _temp_1453		(4 bytes)
	load	[r14+-16],r1
	store	r1,[r14+-24]
!   _temp_1454 = numberOfPages * 4		(int)
	load	[r14+8],r1
	load	[r1+4],r1
	mov	4,r2
	mul	r1,r2,r1
...
! IF STATEMENT...
	...
	mov	"\0\0IF",r10
!   if intIsZero (numBytes) then goto _Label_1461
	load	[r14+20],r1
	cmp	r1,r0
	be	_Label_1461
	jmp	_Label_1462
...
! IF STATEMENT...
	mov	1278,r13		! source line 1278
	mov	"\0\0IF",r10
!   if numBytes >= 0 then goto _Label_1465		(int)
	load	[r14+20],r1
	mov	0,r2
	cmp	r1,r2
	bvs	_runtimeErrorOverflow
...
! IF STATEMENT...
	...
	mov	"\0\0IF",r10
!   if virtPage < numberOfPages then goto _Label_1470		(int)
	load	[r14+-40],r1
	load	[r14+8],r2
	load	[r2+4],r2
	cmp	r1,r2
...
!   Send message IsValid
	...
	add	r2,36,r2
	call	r2
!   Retrieve Result: targetName=_temp_1474  sizeInBytes=1
	loadb	[r15],r1
	storeb	r1,[r14+-10]
!   if _temp_1474 then goto _Label_1473 else goto _Label_1472
	loadb	[r14+-10],r1
	cmp	r1,0
	be	_Label_1472
	jmp	_Label_1473
...
!   Retrieve Result: targetName=_temp_1477  sizeInBytes=4
	load	[r15],r1
	store	r1,[r14+-20]
!   fromAddr = _temp_1477 + offset		(int)
	load	[r14+-20],r1
	load	[r14+-44],r2
	add	r1,r2,r1
	bvs	_runtimeErrorOverflow
...
! WHILE STATEMENT...
	...
	mov	"\0\0WH",r10
_Label_1479:
!   if offset >= 8192 then goto _Label_1481		(int)
	load	[r14+-44],r1
	mov	8192,r2
	cmp	r1,r2
	bvs	_runtimeErrorOverflow
...
!   if intIsZero (fromAddr) then goto _runtimeErrorNullPointer
	...
	cmp	r1,r0
	be	_runtimeErrorNullPointer
!   Data Move: _temp_1482 = *fromAddr  (sizeInBytes=1)
	load	[r14+-48],r1
	loadb	[r1],r1
	storeb	r1,[r14+-9]
!   Data Move: *kernelAddr = _temp_1482  (sizeInBytes=1)
	loadb	[r14+-9],r1
	load	[r14+12],r2
	storeb	r1,[r2]
! ASSIGNMENT STATEMENT...
...
! IF STATEMENT...
	...
	mov	"\0\0IF",r10
!   if copiedSoFar != numBytes then goto _Label_1484		(int)
	load	[r14+-36],r1
	load	[r14+20],r2
	cmp	r1,r2
	bne	_Label_1484
...
! IF STATEMENT...
	...
	mov	"\0\0IF",r10
!   if intIsZero (numBytes) then goto _Label_1501
	load	[r14+20],r1
	cmp	r1,r0
	be	_Label_1501
	jmp	_Label_1502
...
! IF STATEMENT...
	mov	1328,r13		! source line 1328
	mov	"\0\0IF",r10
!   if numBytes >= 0 then goto _Label_1505		(int)
	load	[r14+20],r1
	mov	0,r2
	cmp	r1,r2
	bvs	_runtimeErrorOverflow
...
! IF STATEMENT...
	...
	mov	"\0\0IF",r10
!   if virtPage < numberOfPages then goto _Label_1512		(int)
	load	[r14+-36],r1
	load	[r14+8],r2
	load	[r2+4],r2
	cmp	r1,r2
...
!   Send message IsValid
	...
	add	r2,36,r2
	call	r2
!   Retrieve Result: targetName=_temp_1513  sizeInBytes=1
	loadb	[r15],r1
	storeb	r1,[r14+-11]
!   if _temp_1513 then goto _Label_1511 else goto _Label_1509
	loadb	[r14+-11],r1
	cmp	r1,0
	be	_Label_1509
	jmp	_Label_1511
...
!   Send message IsWritable
	...
	add	r2,32,r2
	call	r2
!   Retrieve Result: targetName=_temp_1515  sizeInBytes=1
	loadb	[r15],r1
	storeb	r1,[r14+-10]
!   if _temp_1515 then goto _Label_1510 else goto _Label_1509
	loadb	[r14+-10],r1
	cmp	r1,0
	be	_Label_1509
	jmp	_Label_1510
...
!   Send message ExtractFrameAddr
	...
	add	r2,12,r2
	call	r2
!   Retrieve Result: targetName=_temp_1517  sizeInBytes=4
	load	[r15],r1
	store	r1,[r14+-20]
!   destAddr = _temp_1517 + offset		(int)
	load	[r14+-20],r1
	load	[r14+-40],r2
	add	r1,r2,r1
	bvs	_runtimeErrorOverflow
...
! WHILE STATEMENT...
	...
	mov	"\0\0WH",r10
_Label_1519:
!   if offset >= 8192 then goto _Label_1521		(int)
	load	[r14+-40],r1
	mov	8192,r2
	cmp	r1,r2
	bvs	_runtimeErrorOverflow
...
!   if intIsZero (kernelAddr) then goto _runtimeErrorNullPointer
	...
	cmp	r1,r0
	be	_runtimeErrorNullPointer
!   Data Move: _temp_1522 = *kernelAddr  (sizeInBytes=1)
	load	[r14+16],r1
	loadb	[r1],r1
	storeb	r1,[r14+-9]
!   Data Move: *destAddr = _temp_1522  (sizeInBytes=1)
	loadb	[r14+-9],r1
	load	[r14+-44],r2
	storeb	r1,[r2]
! ASSIGNMENT STATEMENT...
...
! IF STATEMENT...
	...
	mov	"\0\0IF",r10
!   if copiedSoFar != numBytes then goto _Label_1524		(int)
	load	[r14+-32],r1
	load	[r14+20],r2
	cmp	r1,r2
	bne	_Label_1524
...
!   Retrieve Result: targetName=_temp_1543  sizeInBytes=4
	load	[r15],r1
	store	r1,[r14+-40]
!   if _temp_1543 >= 4 then goto _Label_1542		(int)
	load	[r14+-40],r1
	mov	4,r2
	cmp	r1,r2
	bvs	_runtimeErrorOverflow
...
! IF STATEMENT...
	...
	mov	"\0\0IF",r10
!   if sourceSize <= maxSize then goto _Label_1547		(int)
	load	[r14+-44],r1
	load	[r14+20],r2
	cmp	r1,r2
	bvs	_runtimeErrorOverflow
...
! RETURN STATEMENT...
	...
	mov	1394,r13		! source line 1394
	mov	"\0\0SE",r10
!   _temp_1550 = kernelAddr		(4 bytes)
	load	[r14+12],r1
	store	r1,[r14+-20]
!   _temp_1549 = _temp_1550 + 4		(int)
	load	[r14+-20],r1
	mov	4,r2
	add	r1,r2,r1
	bvs	_runtimeErrorOverflow
	store	r1,[r14+-24]
!   _temp_1551 = virtAddr + 4		(int)
	load	[r14+16],r1
	mov	4,r2
	add	r1,r2,r1
	bvs	_runtimeErrorOverflow
	...
	load	[r14+8],r1
	store	r1,[r14+-12]
!   if intIsZero (_temp_1552) then goto _runtimeErrorNullPointer
	load	[r14+-12],r1
	cmp	r1,r0
	be	_runtimeErrorNullPointer
!   Prepare Argument: offset=12  value=_temp_1549  sizeInBytes=4
	load	[r14+-24],r1
	store	r1,[r15+4]
!   Prepare Argument: offset=16  value=_temp_1551  sizeInBytes=4
	load	[r14+-16],r1
	store	r1,[r15+8]
...
!   Send message CopyBytesFromVirtual
	...
	add	r2,76,r2
	call	r2
!   Retrieve Result: targetName=_temp_1548  sizeInBytes=4
	load	[r15],r1
	store	r1,[r14+-28]
!   ReturnResult: _temp_1548  (sizeInBytes=4)
	load	[r14+-28],r1
	store	r1,[r14+8]
	add	r15,56,r15
	pop	r13
